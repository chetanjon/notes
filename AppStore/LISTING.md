...
> on any other iPhone; there the sparkle is a menu with three more on-device
> actions, "Add a title", "Tidy up" and "Sort the list". Deleted notes wait in the Trash, behind the trash
