...
> last asks for Reminders access when its Add button is tapped, the app's
> only permission prompt). Deleted notes wait in the Trash, behind the trash
